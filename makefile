...
# make sure /src and /design contain the same files
# top level module (checked before each run)
TOP = tb_cardinal_mesh4x4
TOP_SYN = tb_cardinal_router_bidirectional_syn
DESIGN_NAME = cardinal_mesh4x4
